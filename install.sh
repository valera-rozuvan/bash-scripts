...
ln -s $WD/bash/gen_ssh_key.sh                 ~/bin/gen_ssh_key.sh
ln -s $WD/bash/rnd_str.sh                     ~/bin/rnd_str.sh
ln -s $WD/linux-setup/setup-debian-10-xfce.sh ~/bin/setup-debian-10-xfce.sh
