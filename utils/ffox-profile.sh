...
#                                                                              #
# Script: ffox-profile.sh                                                      #
# Description: Launches Firefox with a specified profile. Part of the          #
#              collection of scripts to work with Firefox profiles:            #
#                - ffox-add-profile.sh                                         #
#                - ffox-private.sh                                             #
#                - ffox-profile.sh                                             #
#                                                                              #
...
if [ -d "$DIRECTORY_TO_CHECK" ]; then
  echo "   |--> Directory exists. Starting firefox with specified profile..."
  echo "firefox -profile \"${DIRECTORY_TO_CHECK}\""
  /home/valera/bin/firefox/firefox -profile "${DIRECTORY_TO_CHECK}"
else
  echo "   |--> Directory does not exist. No action taken."
fi
